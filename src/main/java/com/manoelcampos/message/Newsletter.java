...
public class Newsletter {
    ...
    private final MessageService messageSender;
     ...
     * @param messageSender o serviço de envio de mensagens a ser utilizado
     */
    public Newsletter(final List<Customer> customers, final MessageService messageSender){
    ...
    public void send(final String msgTemplate) {
        for (final Customer customer : customers) {
            messageSender.send(formatMsg(customer, msgTemplate), customer);
        }
    }
